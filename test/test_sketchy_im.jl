@testset "Test Sketchy Influence Matrix" begin
    ...
    ims = Dict{IMBP.IMID, IMBP.SketchyIM{Array{ComplexF64, 4}}}(
        IMBP.IMID(1, true, (1, 0)) => IMBP._random_im(IMBP.SketchyIM{Array{ComplexF64, 4}}, rng, 3, 21),
        IMBP.IMID(2, false, (0, 2)) => IMBP._random_im(IMBP.SketchyIM{Array{ComplexF64, 4}}, rng, 3, 21),
    ...
    new_im, _ = IMBP.contract(equation, ims, kernels, one_qubit_gates, initial_state, 50, 21; rng)
